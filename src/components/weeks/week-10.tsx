...
export default function Week10() {
    ...
    return (
        <section id="week10" className="relative min-h-screen pb-4 w-full text-neutral-900 flex flex-col gap-y-8 pt-16 px-8 lg:p-20 lg:scroll-mt-[-54px] 3xl:scroll-mt-0 lg:pb-4" style={bg}>
