...
export default function Week6() {
    return (
        <section id="week6" className="relative min-h-screen w-full bg-[radial-gradient(circle_at_bottom,_var(--tw-gradient-stops))] from-[#0d1a2d] from-40% via-[#531f61] via-55% to-[#0d1a2d] to-65% text-neutral-100 flex flex-col gap-y-8 pt-16 px-8 lg:p-20">
