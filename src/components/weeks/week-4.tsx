export default function Week4() {
    return (
        <section id="week4" className="min-h-screen pb-4 lg:pb-0 w-full bg-gradient-to-br from-zinc-100 from-40% via-[#e0fef8] via-65% to-zinc-100 to-70% text-slate-900 flex flex-col gap-y-8 pt-16 px-8 lg:p-20">
